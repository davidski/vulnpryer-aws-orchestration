...
def build_datapipeline() :
  ...
  print 'Pipeline ' + config.get('data_pipeline','pipeline_name') + ' with ID ' + pipeline_id + ' created on ' + config.get('general','pipeline_aws_region') 
